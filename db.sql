...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `email`, `user_address`, `contact_number`, `user_type`, `location_url`, `password_salt`, `password`, `user_avatar`, `is_user_deleted`, `created_at`) VALUES
('9449f51c-c555-4f71-8962-770632e60164', 'Sachin', '', 'elavarasan@bitittude.com', NULL, NULL, 2, NULL, '$2a$10$KesO2efNZD.bLq3kycEPFO', '$2a$10$KesO2efNZD.bLq3kycEPFO78x3brhcfV.Ti2VCBkrmsJZaVueZLbS', NULL, 0, NULL);
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `email`, `user_address`, `contact_number`, `user_type`, `location_url`, `password_salt`, `password`, `user_avatar`, `is_user_deleted`, `created_at`) VALUES
